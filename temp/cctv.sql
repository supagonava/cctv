...
INSERT INTO `users` (`id`, `username`, `password_hash`, `firstname`, `lastname`, `sex`, `dob`, `phone`, `email`, `lineId`, `facebook`, `auth_key`) VALUES
(1, 'admin', '$2y$10$o.fiM3GY3./oEbNDDSyjUOdyPhqlQUvZiFB2tGb55dw04/KbKH.5O', 'super', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
